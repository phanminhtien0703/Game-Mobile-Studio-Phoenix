                    ...
                    <div class="card-body">
                      <form action="{{ route('admin.games.update', $game->game_id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="file" class="form-control @error('avatar_url') is-invalid @enderror" id="avatar_url" name="avatar_url" accept="image/*">
                          <small class="form-text text-muted">Tối đa 2MB (JPEG, PNG, JPG, GIF) - Tự động nén trước upload. Để trống nếu không muốn thay đổi</small>
                          @if($game->avatar_url)
                            <div class="mt-2">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control @error('fanpage_support') is-invalid @enderror" id="fanpage_support" name="fanpage_support" placeholder="Nhập URL Facebook fanpage hoặc Messenger (VD: https://www.facebook.com/...)" value="{{ old('fanpage_support', $game->fanpage_support) }}">
