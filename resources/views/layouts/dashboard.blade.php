<!-- Menu -->
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Quản lý Game -->
            <li class="menu-item {{ request()->routeIs('admin.games.*') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-game"></i>
                <div class="text-truncate" data-i18n="Quản lý Game">Quản lý Game</div>
              </a>
              ...
              <ul class="menu-sub">
                <li class="menu-item {{ request()->routeIs('admin.games.index') ? 'active' : '' }}">
                  <a href="{{ route('admin.games.index') }}" class="menu-link">
                    ...
                    <div class="text-truncate" data-i18n="Danh sách Game">Danh sách Game</div>
                  </a>
                </li>
